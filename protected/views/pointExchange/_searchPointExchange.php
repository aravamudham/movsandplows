...
$('.search-form form').submit(function(){
    ...
    if (userName.length == 0){
        $('#PointExchange_userId' ).removeAttr('value');
    }
...
<div class="search-form">
    ...
    <div class="row">
        <div class="col-sm-2">
            <?php echo $form->dropDownList($pointExchange, 'paymentMethod', $paymentMethod, array('style' => '', 'class' => 'input-sm form-control', 'prompt' => Yii::t('common', 'title.allTypes'))); ?>
        </div>

        <div class="col-sm-2">
            <?php
            echo $form->hiddenField($pointExchange, 'userId');
            $this->widget('zii.widgets.jui.CJuiAutoComplete', array(
                ...
                'options' => array(
                    ...
                    jQuery("#PointExchange_userId").val(ui.item["id"]);
                    }'
                ),
                'htmlOptions' => array(
                    'type' => 'text',
        ...
        <div class="col-sm-2">
            <?php echo $form->textField($pointExchange, 'start_date', array(
        ...
        <div class="col-sm-2">
            <?php echo $form->textField($pointExchange, 'end_date', array(
                'class' => 'form-control form-control-inline input-sm date-picker',
                'data-date-format' => 'yyyy-mm-dd',
