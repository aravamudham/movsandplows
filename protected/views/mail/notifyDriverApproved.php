...
<head>
    ...
    <title>Link Rider | Driver Registration</title>
    <style type="text/css">
        html {
            ...
            <td align="center" bgcolor="#eff3f8">
				...
				Item -->
                                        <div class="mob_center_bl"
                                             style="float: left; display: inline-block; width: 170px;">
                                            <table class="mob_center" width="170" border="0" cellspacing="0"
                                                        ...
                                                        <table width="170" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                <td align="left" valign="top" class="mob_center">
                                                                    <span
                                                                        style="font-family: Arial, Helvetica, sans-serif; font-size: 34px; color: #4db3a4;">
                                                                        Link Rider
                                                                    </span>
                                                                </td>
                                                            </tr>
				...
				Item -->
                                        <div class="mob_center_bl"
                                             style="float: right; display: none; width: 88px;">
                                                                                    ...
                                                                                    <a href="#" target="_blank"
                                                                                       style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 12px;">
                                                                                        <font
                                                                                            ...
                                                                                            size="2" color="#596167">
                                                                                            <img
                                                                                                src="http://artloglab.com/metromail2/images/facebook.gif"
                                                                                                width="10" height="19"
                                                                                                alt="Facebook"
                                                                                                border="0"
                                                                                    ...
                                                                                    <a href="#" target="_blank"
                                                                                       style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 12px;">
                                                                                        <font
                                                                                            ...
                                                                                            size="2" color="#596167">
                                                                                            <img
                                                                                                src="http://artloglab.com/metromail2/images/twitter.gif"
                                                                                                width="19" height="16"
                                                                                    ...
                                                                                    <a href="#" target="_blank"
                                                                                       style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 12px;">
                                                                                        <font
                                                                                            ...
                                                                                            size="2" color="#596167">
                                                                                            <img
                                                                                                src="http://artloglab.com/metromail2/images/dribbble.gif"
                                                                                                width="19" height="19"
                                                                                                alt="Dribbble"
                                                                                                border="0"
                                                                                                style="display: block;"/></font></a>
						...
						Dear: <?php echo $name; ?>
                                ...
                                <tr>
									...
									<span
                                        ...
                                        Your account has become a driver!
									</span></font>
                                                    </div>
                                                </td>
                                            </tr>
                    ...
                    <tr>
		              ...
		              &nbsp;&nbsp;&nbsp;&nbsp;<img src="http://artloglab.com/metromail2/images/dot.gif" alt="|"
                                                   width="6" height="9" class="mob_display_none" style="display: none;"/></a>&nbsp;&nbsp;&nbsp;&nbsp;
		              <a href="#" target="_blank" style="color: #5b9bd1; text-decoration: none;">TERMS &amp;
                          CONDITIONS</a>
		              &nbsp;&nbsp;&nbsp;&nbsp;<img src="http://artloglab.com/metromail2/images/dot.gif" alt="|"
                                                   width="6" height="9" class="mob_display_none" style="display: none;"/>&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<span style="font-family: Arial, Helvetica, sans-serif; font-size: 13px; color: #96a5b5;">
                    2016 &copy; Link Rider. All Rights Reserved.
				</span></font>
                                    </td>
                                </tr>
                            </table>
