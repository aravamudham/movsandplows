...
<head>
    ...
    <title>Link Rider | Request Document</title>
    <style type="text/css">
...
<div id="mailsub" class="notification" align="center">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="min-width: 320px;"><tr><td align="center" bgcolor="#eff3f8">
				...
				Item --><div class="mob_center_bl" style="float: left; display: inline-block; width: 170px;">
                                                ...
                                                <tr><td align="left" valign="middle">
                                                        ...
                                                        <table width="170" border="0" cellspacing="0" cellpadding="0" >
                                                            <tr><td align="left" valign="top" class="mob_center">
                                                                    <span style="font-family: Arial, Helvetica, sans-serif; font-size: 34px; color: #4db3a4;">
                                                                        Link Rider
                                                                    </span>
                                                                </td></tr>
                                                        </table>
				...
				Item --><div class="mob_center_bl" style="float: right; display: inline-block; width: 88px;">
						...
						Dear <?php echo $user; ?>
                                ...
                                <tr><td align="center">
									...
									<span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">
                                        We have checked your document and it is invalid. And your driver registration couldn't be approved. Please check and send us document again
									</span></font>
                                                    </div>
                                                </td></tr>
                                        </table>
                    ...
                    <tr><td align="center" bgcolor="#f9fafc">
		              ...
		              &nbsp;&nbsp;&nbsp;&nbsp;<img src="http://artloglab.com/metromail2/images/dot.gif" alt="|" width="6" height="9" class="mob_display_none" /></a>&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<span style="font-family: Arial, Helvetica, sans-serif; font-size: 13px; color: #96a5b5;">
                    2015 &copy; Link Rider. All Rights Reserved.
				</span></font>
                                    </td></tr>
                            </table>
